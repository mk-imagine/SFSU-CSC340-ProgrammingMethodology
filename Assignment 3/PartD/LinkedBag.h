...
public:
	...
	ItemType getMostFrequent() const;
	// ItemType addRandom340();
	shared_ptr<Node<ItemType>> getPtrToMostFrequent();
	int removeMostFrequent(shared_ptr<Node<ItemType>> nodePtr);
private:
